...
def Init(jocore, script_type, glob):
    #stype = globals().get('stype_')
    #if script_type == stype or \
            #(script_type in ('jooscript', 'class') and \
             #stype in ('jooscript', 'class')):
        #return tokens
...
def parse(parent, source, starting_line_number=1, strictMode=False, 
